 ...
 * @method static int updateAllCounters(array $ids, array $counters, array $extra = [])
 * @method static int updateAllCountersByWhere(array $attributes, array $counters, array $extra = [])
